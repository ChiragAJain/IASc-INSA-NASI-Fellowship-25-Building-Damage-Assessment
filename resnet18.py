...
def train(model, criterion, optimizer, scheduler, train_dataset, k_folds=8, patience=5, num_epochs=15, save_dir='checkpoints_ResNet18_xView2_2', batch_size=32, device='cuda'):
    NUM_CLASSES = 4
...
if __name__ == '__main__':
    ...
    torch.save(model.state_dict(), "resnet18_xview2_2.pth")
