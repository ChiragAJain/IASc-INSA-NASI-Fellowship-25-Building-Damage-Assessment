...
class ResidualBlock(nn.Module):
    def __init__(self, in_channels, out_channels, use_se=False, downsample=False, bottleneck=True):
        super().__init__()
...
class CNN(nn.Module):
    def __init__(self,num_classes):
        ...
        self.initial = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=64, kernel_size=7, stride=2, padding=3),  # 7×7 Conv with stride 2
            nn.BatchNorm2d(64),
            nn.ReLU(),
