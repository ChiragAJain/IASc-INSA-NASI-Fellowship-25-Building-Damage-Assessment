...
from layerv3 import FocalLoss,CNN




def train(model, criterion, optimizer, scheduler, train_dataset, k_folds=8, patience=5, num_epochs=15, save_dir='checkpoints_CNN_xView2', batch_size=32, device='cuda'):
    NUM_CLASSES = 4
...
if __name__ == '__main__':
    ...
    print(CNN.get_summary(model,3,IMG_SIZE))
    torch.backends.cudnn.benchmark = True
    criterion = FocalLoss(alpha=weights.to(DEVICE), gamma=3)
    ...
    torch.save(model.state_dict(), "CNN_xview2.pth")
